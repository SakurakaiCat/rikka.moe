...
export const t = {
  ...
  ui: {
    ...
    theme: { 'zh-CN': '主题', 'zh-TW': '主題', en: 'Theme', ja: 'テーマ' },
    themeAuto: { 'zh-CN': '自动', 'zh-TW': '自動', en: 'Auto', ja: '自動' },
    themeDark: { 'zh-CN': '深色', 'zh-TW': '深色', en: 'Dark', ja: 'ダーク' },
    themeParchment: { 'zh-CN': '羊皮纸', 'zh-TW': '羊皮紙', en: 'Parchment', ja: '羊皮紙' },
